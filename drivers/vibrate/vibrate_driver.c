...
static ssize_t dev_write(struct file *filep, const char __user *buffer, size_t len, loff_t *offset) {
    ...
    if (strcmp(kbuf, "D") == 0 || strcmp(kbuf, "a") == 0) {
        duty_ns = 3600000; // 18%
    } 
    else if (strcmp(kbuf, "C") == 0 || strcmp(kbuf, "b") == 0) {
        duty_ns = 1200000; // 12%
    } 
    else if (strcmp(kbuf, "B") == 0 || strcmp(kbuf, "c") == 0) {
        duty_ns = 800000;  // 4%
    } 
    else if (strcmp(kbuf, "A") == 0 || strcmp(kbuf, "d") == 0) {
        duty_ns = 0;        // 0%
    } 
    else {
        u64 custom_val = 0;
